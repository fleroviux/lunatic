...
namespace lunatic::frontend {
  ...
  namespace detail {
    ...
    inline U decode_data_processing(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_move_status_register(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_move_register_status(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_multiply(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_multiply_long(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_single_data_swap(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_branch_exchange(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_halfword_signed_transfer(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_single_data_transfer(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_block_data_transfer(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_branch_relative(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_coprocessor_register_transfer(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_svc(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_count_leading_zeros(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_saturating_add_sub(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_signed_halfword_multiply(Condition condition, u32 opcode, T& client) {
    ...
    template<typename T, typename U = typename T::return_type>
    inline U decode_branch_link_exchange_relative(u32 opcode, T& client) {
      auto offset = opcode & 0xFFFFFF;
  ...
  template<typename T, typename U = typename T::return_type>
  inline U decode_arm(u32 instruction, T& client) {
